 ...
 *  - 표시명(nameKo)은 오너가 준 원본 파일명 그대로(한국 사용자용).
 *
...
export const PRESET_ALARM_SOUNDS: PresetAlarmSound[] = [
  { fileId: 'preset_knock', nameKo: '조심스레 노크하는', durationMs: 1680 },
  { fileId: 'preset_waterdrop', nameKo: '물방울 느낌 통통튀는', durationMs: 2540 },
  { fileId: 'preset_shortloop', nameKo: '그냥 짧게 반복 알림으로 쓸법한', durationMs: 3020 },
  { fileId: 'preset_dreamy', nameKo: '몽환적이면서 리듬감 있는', durationMs: 4050 },
  { fileId: 'preset_bouncy', nameKo: '통통 튀면서 중독성 있는', durationMs: 8410 },
  { fileId: 'preset_dramatic', nameKo: '극적이면서 꼭 약을 먹어야할거 같은', durationMs: 12560 },
  { fileId: 'preset_cheerful', nameKo: '기분 좋으면서 리듬감 느껴지는', durationMs: 16400 },
  { fileId: 'preset_trot', nameKo: '딱 트로트 같은', durationMs: 16660 },
  { fileId: 'preset_calm', nameKo: '리듬감 있는데 차분하기도 한', durationMs: 18050 },
  { fileId: 'preset_ballad', nameKo: '구슬픈 듯 하면서 노래를 불러주는 느낌', durationMs: 18120 },
  { fileId: 'preset_lullaby', nameKo: '틀어놓고 자도 될거 같은', durationMs: 19220 },
  { fileId: 'preset_sitcom', nameKo: '시트콤 주인공 행복한 일상 느낌', durationMs: 25030 },

...
// effect_tracking_queue (약효추적) 와 meal_schedules (식사 알림) 중 더 가까운 것 선택.
...
async function fetchNextNotifMessage(patientId: string): Promise<string | null> {
  try {
    ...
    const mealSchedules: Record<string, string> = (userData?.meal_schedules as Record<string, string>) ?? {
      morning: '08:00',
      lunch: '12:00',
      dinner: '18:00',
      bedtime: '22:00',
